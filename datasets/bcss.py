...
class BCSSTrainingDataset(Dataset):
    # TUM-肿瘤 STR-间质 LYM-淋巴 NEC-坏死组织 BACK-背景
    CLASSES = ["TUM", "STR", "LYM", "NEC", "BACK"]
    def __init__(self, img_root="/data/users/huming/Datasets/BCSS-WSSS/train/img", transform=None):
...
class BCSSTestDataset(Dataset):
    # TUM-肿瘤 STR-间质 LYM-淋巴 NEC-坏死组织 BACK-背景
    CLASSES = ["TUM", "STR", "LYM", "NEC", "BACK"]
    def __init__(self, img_root="/data/users/huming/Datasets/BCSS-WSSS/", split="test", transform=None):
